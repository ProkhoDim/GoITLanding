...
https://github.com/ProkhoDim/GoITLanding/invitations
...
# !
- в новом окне обязательно проверяем, чтобы ПЕРВЫЙ выпадающий список был 'base:dev', иначе пулл-реквест будет закрыт и ветка будет удалена.
# !
